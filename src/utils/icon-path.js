 ...
 *
 * Файлы иконок физически лежат в public/v2/assets/icons/{slug}.svg
 * Реестр (хэши, размеры, generic-флаг) — в public/v2/assets/icons/manifest.json
 */

const ICON_BASE = '/v2/assets/icons/';
