...
📌 Блок "travel" — командировочные (рассчитывай НА КАЖДОГО × ВСЕ ДНИ):
  ...
  - Проживание: 2 500-3 500₽/чел/ночь (гостиница или аренда квартиры). На весь period.
  - Билеты:
...

{
  ...
  "calculation": {
    ...
    "travel": [
      ...
      {"description": "Проживание (3000₽/чел/ночь)", "count": <crew>, "price": <work_days × 3000>, "total": <итого>},
