...
📌 Оборудование (ОБЯЗАТЕЛЬНО УЧТИ — ЭТО КРУПНАЯ СТАТЬЯ):
  ...
  ОБЯЗАТЕЛЬНОЕ ОБОРУДОВАНИЕ ПО ТИПАМ РАБОТ:
  ┌─────────────────────┬──────────────────────────────────────────────────────┬───────────────┐
  │ Тип работ           │ Оборудование                                       │ Аренда/мес    │
  ├─────────────────────┼──────────────────────────────────────────────────────┼───────────────┤
  │ HYDRO_MECH/HYDRO_DYN│ АВД установка (500-1500 бар), шланги ВД Ø19-33мм,  │ 150-300 тыс₽  │
  │                     │ насадки/сопла для труб, пистолет ВД                 │               │
  ├─────────────────────┼──────────────────────────────────────────────────────┼───────────────┤
  │ CHEM                │ Насосы перекачки, ёмкости для растворов, фитинги,   │ 80-150 тыс₽   │
  │                     │ обвязка, КИП (pH-метр, термометр)                   │               │
  ├─────────────────────┼──────────────────────────────────────────────────────┼───────────────┤
  │ HVAC                │ Подъёмники/леса, инструмент монтажа, вентиляц. тест │ 80-200 тыс₽   │
  ├─────────────────────┼──────────────────────────────────────────────────────┼───────────────┤
  │ MOUNT               │ Леса/подмости, сварочные аппараты, грузоподъёмное   │ 100-250 тыс₽  │
  ├─────────────────────┼──────────────────────────────────────────────────────┼───────────────┤
  │ INSULATION          │ Леса/подмости, газовые горелки, прокатка            │ 50-100 тыс₽   │
  └─────────────────────┴──────────────────────────────────────────────────────┴───────────────┘
  ...
  ⚠️ Если ты НЕ добавил оборудование ни в current_costs ни в purchases_needed —
  ПЕРЕПРОВЕРЬ. Работа БЕЗ оборудования не бывает.
