...
📌 Оборудование (ОБЯЗАТЕЛЬНО УЧТИ — ЭТО КРУПНАЯ СТАТЬЯ):
  ...
  ├─────────────────────┼──────────────────────────────────────────────────────┼───────────────┤
  │ HYDRO_MECH/HYDRO_DYN│ Установка гидромеханической очистки (Вулкан/Тайфун),│ ПОКУПКА:      │
  │                     │ шланги ВД, насадки/сопла под диаметр труб,          │ 800-2000 тыс₽ │
  │                     │ запасные головки, фильтры                           │               │
  ├─────────────────────┼──────────────────────────────────────────────────────┼───────────────┤
