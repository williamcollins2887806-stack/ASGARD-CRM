...
═══ КЛЮЧЕВЫЕ ПРАВИЛА ═══
- Билеты: считай от ГОРОДА ПРОЖИВАНИЯ сотрудника (не от Саратова). Данные в employees.city.
  Маршрут: город сотрудника → Москва (склад, 2-3 дня) → город объекта. Каждый сегмент отдельно.
