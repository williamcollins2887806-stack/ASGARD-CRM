...
- Тип очистки: определяй СТРОГО из ТЗ/договора. Гидромеханическая очистка ≠ АВД (аппарат высокого давления).
  Гидромеханическая = специальные установки (Тайфун, Вулкан, Посейдон) с вращающимися головками.
  АВД = аппараты высокого давления (Керхер и т.п.) — другая технология.
  Изучи тип отложений из ТЗ (магнетит, накипь, полимер и т.д.) и подбери оборудование АДЕКВАТНОЕ типу.
...
- Оборудование: перечисли ВСЁ что нужно в equipment_needed. НЕ решай что на складе — сервер проверит.
