#!/usr/bin/env python3
"""Deploy funnel apps: marketplace + PK3 kanban columns + sheets."""
import io
import os
import subprocess
import sys
...
def main():
    ...
    _, o, e = c.exec_command(
        ...
        "grep -c funnel-apps /var/www/asgard-crm/src/routes/tenders-hub.js && "
        "grep -c marketplace /var/www/asgard-crm/public/assets/js/hub_funnel_tab.js",
        timeout=120,
    )
