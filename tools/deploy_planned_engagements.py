#!/usr/bin/env python3
"""Deploy: planned engagements (V288) + Personnel UI (react/vanilla/mobile)."""
import io
import os
import subprocess
import sys
...
UPLOAD = [
    "migrations/V289__employees_headwear_size.sql",
    "migrations/V290__employees_clothing_size_wider.sql",
    "src/routes/staff.js",
