...
\restrict tQuFFaaTL42XFfF5rJgWzTtdNBa1BPk1d1LeETXczHOdbMbUO6tCtz75PKRAvG3
...
--
-- Name: assembly_items; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.assembly_items (
    ...
    notes text,
    created_at timestamp without time zone DEFAULT now(),
    CONSTRAINT assembly_items_return_status_check CHECK (((return_status IS NULL) OR ((return_status)::text = ANY ((ARRAY['returning'::character varying, 'damaged'::character varying, 'lost'::character varying, 'consumed'::character varying])::text[])))),
    CONSTRAINT assembly_items_source_check CHECK (((source)::text = ANY ((ARRAY['reservation'::character varying, 'procurement_warehouse'::character varying, 'procurement_object'::character varying, 'manual'::character varying, 'on_site_purchase'::character varying])::text[])))
);


--
-- Name: assembly_items_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: assembly_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.assembly_orders (
    ...
    planned_date date,
    actual_sent_at timestamp without time zone,
    actual_received_at timestamp without time zone,
    ...
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    CONSTRAINT assembly_orders_status_check CHECK (((status)::text = ANY ((ARRAY['draft'::character varying, 'confirmed'::character varying, 'packing'::character varying, 'packed'::character varying, 'in_transit'::character varying, 'received'::character varying, 'returned'::character varying, 'closed'::character varying])::text[]))),
    CONSTRAINT assembly_orders_type_check CHECK (((type)::text = ANY ((ARRAY['mobilization'::character varying, 'demobilization'::character varying, 'transfer'::character varying])::text[])))
);


--
-- Name: assembly_orders_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.assembly_orders_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: assembly_orders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.assembly_orders_id_seq OWNED BY public.assembly_orders.id;


--
-- Name: assembly_pallets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.assembly_pallets (
    id integer NOT NULL,
    assembly_id integer NOT NULL,
    ...
    received_at timestamp without time zone,
    received_by integer,
    scanned_lat numeric(9,6),
    scanned_lon numeric(9,6),
    notes text,
    created_at timestamp without time zone DEFAULT now(),
    CONSTRAINT assembly_pallets_status_check CHECK (((status)::text = ANY ((ARRAY['open'::character varying, 'packed'::character varying, 'shipped'::character varying, 'received'::character varying])::text[])))
);


--
-- Name: assembly_pallets_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.assembly_pallets_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: assembly_pallets_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.assembly_pallets_id_seq OWNED BY public.assembly_pallets.id;
...
--
-- Name: mimir_hint_analysis_cache; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.mimir_hint_analysis_cache (
...
CREATE TABLE public.pre_tender_requests (
    ...
    ai_urgency character varying(20),
    ai_auto_suggestion character varying(50),
    ai_risk_factors jsonb,
    ai_required_specialists jsonb,
    ...
    CONSTRAINT pre_tender_requests_status_check CHECK (((status)::text = ANY ((ARRAY['new'::character varying, 'in_review'::character varying, 'need_docs'::character varying, 'accepted'::character varying, 'rejected'::character varying, 'expired'::character varying, 'pending_approval'::character varying, 'approved'::character varying, 'pending_payment'::character varying, 'paid'::character varying, 'cash_issued'::character varying, 'cash_received'::character varying, 'expense_reported'::character varying])::text[])))
);
...
--
-- Name: procurement_history; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: procurement_history_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.procurement_history_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: procurement_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.procurement_history_id_seq OWNED BY public.procurement_history.id;
...
CREATE TABLE public.procurement_items (
    ...
    delivery_target character varying(20) DEFAULT 'warehouse'::character varying,
    delivery_address character varying(500),
    warehouse_id integer,
    estimated_delivery date,
    actual_delivery date,
    item_status character varying(30) DEFAULT 'pending'::character varying,
    equipment_id integer,
    received_by integer,
    received_at timestamp without time zone,
    notes text,
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    CONSTRAINT procurement_items_delivery_target_check CHECK (((delivery_target)::text = ANY ((ARRAY['warehouse'::character varying, 'object'::character varying])::text[]))),
    CONSTRAINT procurement_items_item_status_check CHECK (((item_status)::text = ANY ((ARRAY['pending'::character varying, 'ordered'::character varying, 'shipped'::character varying, 'delivered'::character varying, 'cancelled'::character varying])::text[])))
);
...
--
-- Name: procurement_payments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: procurement_payments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.procurement_payments_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: procurement_payments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.procurement_payments_id_seq OWNED BY public.procurement_payments.id;
...
CREATE TABLE public.procurement_requests (
    ...
    deadline_type character varying(20) DEFAULT 'fixed'::character varying,
    deadline_days integer,
    paid_at timestamp without time zone,
    delivered_at timestamp without time zone,
    pm_approved_at timestamp without time zone,
    dir_approved_at timestamp without time zone,
    dir_approved_by integer,
    locked boolean DEFAULT false,
    proc_comment text,
    pm_comment text
);
...
--
-- Name: tmc_requests; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.tmc_requests AS
 SELECT id,
    work_id,
    tender_id,
    request_type,
...
CREATE TABLE public.work_expenses (
    ...
    fot_base_pay numeric(15,2),
    fot_per_diem numeric(15,2),
    fot_bonus numeric(15,2),
    fot_date_from date,
    fot_date_to date
);
...
--
-- Name: assembly_items id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: assembly_orders id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_orders ALTER COLUMN id SET DEFAULT nextval('public.assembly_orders_id_seq'::regclass);


--
-- Name: assembly_pallets id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_pallets ALTER COLUMN id SET DEFAULT nextval('public.assembly_pallets_id_seq'::regclass);
...
--
-- Name: procurement_history id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_history ALTER COLUMN id SET DEFAULT nextval('public.procurement_history_id_seq'::regclass);
...
--
-- Name: procurement_payments id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_payments ALTER COLUMN id SET DEFAULT nextval('public.procurement_payments_id_seq'::regclass);
...
--
-- Name: assembly_items assembly_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assembly_pallets assembly_pallets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_pallets
    ADD CONSTRAINT assembly_pallets_pkey PRIMARY KEY (id);
...
--
-- Name: mimir_hint_analysis_cache mimir_hint_analysis_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mimir_hint_analysis_cache
    ADD CONSTRAINT mimir_hint_analysis_cache_pkey PRIMARY KEY (cache_key);
...
--
-- Name: procurement_history procurement_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_history
    ADD CONSTRAINT procurement_history_pkey PRIMARY KEY (id);
...
--
-- Name: procurement_payments procurement_payments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_payments
    ADD CONSTRAINT procurement_payments_pkey PRIMARY KEY (id);
...
--
-- Name: idx_assembly_items_assembly; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assembly_items_assembly ON public.assembly_items USING btree (assembly_id);


--
-- Name: idx_assembly_items_equipment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assembly_items_equipment ON public.assembly_items USING btree (equipment_id);


--
-- Name: idx_assembly_items_pallet; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assembly_items_pallet ON public.assembly_items USING btree (pallet_id);


--
-- Name: idx_assembly_orders_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assembly_orders_status ON public.assembly_orders USING btree (status);


--
-- Name: idx_assembly_orders_work; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assembly_orders_work ON public.assembly_orders USING btree (work_id);


--
-- Name: idx_assembly_pallets_assembly; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assembly_pallets_assembly ON public.assembly_pallets USING btree (assembly_id);


--
-- Name: idx_assembly_pallets_qr; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_assembly_pallets_qr ON public.assembly_pallets USING btree (qr_uuid);
...
--
-- Name: idx_bonus_requests_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bonus_requests_payment ON public.bonus_requests USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_business_trips_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_business_trips_payment ON public.business_trips USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_chat_messages_chat_last; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chat_messages_chat_last ON public.chat_messages USING btree (chat_id, created_at DESC) WHERE (deleted_at IS NULL);
...
--
-- Name: idx_expenses_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_expenses_payment ON public.expenses USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_office_expenses_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_office_expenses_payment ON public.office_expenses USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_one_time_payments_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_one_time_payments_payment ON public.one_time_payments USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_payroll_sheets_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_payroll_sheets_payment ON public.payroll_sheets USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_pre_tenders_approval; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pre_tenders_approval ON public.pre_tender_requests USING btree (status) WHERE ((status)::text = 'pending_approval'::text);


--
-- Name: idx_pre_tenders_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pre_tenders_payment ON public.pre_tender_requests USING btree (payment_status) WHERE (requires_payment = true);


--
-- Name: idx_procurement_history_req; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_history_req ON public.procurement_history USING btree (procurement_id);


--
-- Name: idx_procurement_items_req; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_items_req ON public.procurement_items USING btree (procurement_id);


--
-- Name: idx_procurement_items_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_items_status ON public.procurement_items USING btree (item_status);


--
-- Name: idx_procurement_payments_req; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_payments_req ON public.procurement_payments USING btree (procurement_id);


--
-- Name: idx_procurement_requests_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_requests_payment ON public.procurement_requests USING btree (payment_status) WHERE (requires_payment = true);


--
-- Name: idx_procurement_requests_pm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_requests_pm ON public.procurement_requests USING btree (pm_id);


--
-- Name: idx_procurement_requests_priority; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_requests_priority ON public.procurement_requests USING btree (priority);


--
-- Name: idx_procurement_requests_proc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_requests_proc ON public.procurement_requests USING btree (proc_id);


--
-- Name: idx_procurement_requests_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_requests_status ON public.procurement_requests USING btree (status);


--
-- Name: idx_procurement_requests_work; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_procurement_requests_work ON public.procurement_requests USING btree (work_id);
...
--
-- Name: idx_tenders_distribution; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tenders_distribution ON public.tenders USING btree (distribution_requested_at) WHERE ((distribution_requested_at IS NOT NULL) AND (handoff_at IS NULL));
...
--
-- Name: idx_training_apps_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_training_apps_payment ON public.training_applications USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_travel_expenses_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_travel_expenses_payment ON public.travel_expenses USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_work_expenses_payment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_work_expenses_payment ON public.work_expenses USING btree (payment_status) WHERE (requires_payment = true);
...
--
-- Name: idx_worker_profiles_employee_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_worker_profiles_employee_id ON public.worker_profiles USING btree (employee_id);


--
-- Name: idx_works_deleted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_works_deleted_at ON public.works USING btree (deleted_at) WHERE (deleted_at IS NOT NULL);
...
--
-- Name: acts acts_work_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.acts
    ADD CONSTRAINT acts_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: assembly_items assembly_items_assembly_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_items
    ADD CONSTRAINT assembly_items_assembly_id_fkey FOREIGN KEY (assembly_id) REFERENCES public.assembly_orders(id) ON DELETE CASCADE;


--
-- Name: assembly_items assembly_items_equipment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_items
    ADD CONSTRAINT assembly_items_equipment_id_fkey FOREIGN KEY (equipment_id) REFERENCES public.equipment(id);


--
-- Name: assembly_items assembly_items_packed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_items
    ADD CONSTRAINT assembly_items_packed_by_fkey FOREIGN KEY (packed_by) REFERENCES public.users(id);


--
-- Name: assembly_items assembly_items_pallet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_items
    ADD CONSTRAINT assembly_items_pallet_id_fkey FOREIGN KEY (pallet_id) REFERENCES public.assembly_pallets(id);


--
-- Name: assembly_items assembly_items_procurement_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_items
    ADD CONSTRAINT assembly_items_procurement_item_id_fkey FOREIGN KEY (procurement_item_id) REFERENCES public.procurement_items(id);


--
-- Name: assembly_items assembly_items_received_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_items
    ADD CONSTRAINT assembly_items_received_by_fkey FOREIGN KEY (received_by) REFERENCES public.users(id);


--
-- Name: assembly_orders assembly_orders_confirmed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_orders
    ADD CONSTRAINT assembly_orders_confirmed_by_fkey FOREIGN KEY (confirmed_by) REFERENCES public.users(id);


--
-- Name: assembly_orders assembly_orders_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_orders
    ADD CONSTRAINT assembly_orders_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: assembly_orders assembly_orders_source_assembly_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_orders
    ADD CONSTRAINT assembly_orders_source_assembly_id_fkey FOREIGN KEY (source_assembly_id) REFERENCES public.assembly_orders(id);


--
-- Name: assembly_orders assembly_orders_work_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_orders
    ADD CONSTRAINT assembly_orders_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id);


--
-- Name: assembly_pallets assembly_pallets_assembly_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_pallets
    ADD CONSTRAINT assembly_pallets_assembly_id_fkey FOREIGN KEY (assembly_id) REFERENCES public.assembly_orders(id) ON DELETE CASCADE;


--
-- Name: assembly_pallets assembly_pallets_received_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assembly_pallets
    ADD CONSTRAINT assembly_pallets_received_by_fkey FOREIGN KEY (received_by) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.bank_transactions
    ADD CONSTRAINT bank_transactions_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;


--
-- Name: bonus_requests bonus_requests_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bonus_requests
    ADD CONSTRAINT bonus_requests_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);


--
-- Name: bonus_requests bonus_requests_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bonus_requests
    ADD CONSTRAINT bonus_requests_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
ALTER TABLE ONLY public.calendar_events
    ADD CONSTRAINT calendar_events_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.cash_requests
    ADD CONSTRAINT cash_requests_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: contracts contracts_work_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contracts
    ADD CONSTRAINT contracts_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.correspondence
    ADD CONSTRAINT correspondence_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;


--
-- Name: customer_reviews customer_reviews_work_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_reviews
    ADD CONSTRAINT customer_reviews_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.documents
    ADD CONSTRAINT documents_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: employee_assignments employee_assignments_work_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.employee_assignments
    ADD CONSTRAINT employee_assignments_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.employee_plan
    ADD CONSTRAINT employee_plan_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.employee_reviews
    ADD CONSTRAINT employee_reviews_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE CASCADE;
...
--
-- Name: estimates estimates_work_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimates
    ADD CONSTRAINT estimates_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;


--
-- Name: expenses expenses_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenses
    ADD CONSTRAINT expenses_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);


--
-- Name: expenses expenses_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenses
    ADD CONSTRAINT expenses_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
ALTER TABLE ONLY public.inbox_applications
    ADD CONSTRAINT inbox_applications_linked_work_id_fkey FOREIGN KEY (linked_work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.incomes
    ADD CONSTRAINT incomes_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: invoices invoices_work_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.invoices
    ADD CONSTRAINT invoices_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.meetings
    ADD CONSTRAINT meetings_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: office_expenses office_expenses_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.office_expenses
    ADD CONSTRAINT office_expenses_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);
...
--
-- Name: office_expenses office_expenses_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.office_expenses
    ADD CONSTRAINT office_expenses_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
--
-- Name: one_time_payments one_time_payments_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.one_time_payments
    ADD CONSTRAINT one_time_payments_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);
...
--
-- Name: one_time_payments one_time_payments_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.one_time_payments
    ADD CONSTRAINT one_time_payments_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
ALTER TABLE ONLY public.one_time_payments
    ADD CONSTRAINT one_time_payments_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.payroll_items
    ADD CONSTRAINT payroll_items_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: payroll_sheets payroll_sheets_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_sheets
    ADD CONSTRAINT payroll_sheets_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);
...
--
-- Name: payroll_sheets payroll_sheets_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_sheets
    ADD CONSTRAINT payroll_sheets_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
ALTER TABLE ONLY public.payroll_sheets
    ADD CONSTRAINT payroll_sheets_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: pre_tender_requests pre_tender_requests_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pre_tender_requests
    ADD CONSTRAINT pre_tender_requests_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);
...
--
-- Name: pre_tender_requests pre_tender_requests_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pre_tender_requests
    ADD CONSTRAINT pre_tender_requests_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);


--
-- Name: procurement_history procurement_history_actor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_history
    ADD CONSTRAINT procurement_history_actor_id_fkey FOREIGN KEY (actor_id) REFERENCES public.users(id);


--
-- Name: procurement_history procurement_history_procurement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_history
    ADD CONSTRAINT procurement_history_procurement_id_fkey FOREIGN KEY (procurement_id) REFERENCES public.procurement_requests(id) ON DELETE CASCADE;


--
-- Name: procurement_items procurement_items_equipment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_items
    ADD CONSTRAINT procurement_items_equipment_id_fkey FOREIGN KEY (equipment_id) REFERENCES public.equipment(id);


--
-- Name: procurement_items procurement_items_invoice_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_items
    ADD CONSTRAINT procurement_items_invoice_doc_id_fkey FOREIGN KEY (invoice_doc_id) REFERENCES public.documents(id);


--
-- Name: procurement_items procurement_items_procurement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_items
    ADD CONSTRAINT procurement_items_procurement_id_fkey FOREIGN KEY (procurement_id) REFERENCES public.procurement_requests(id) ON DELETE CASCADE;


--
-- Name: procurement_items procurement_items_received_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_items
    ADD CONSTRAINT procurement_items_received_by_fkey FOREIGN KEY (received_by) REFERENCES public.users(id);


--
-- Name: procurement_items procurement_items_warehouse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_items
    ADD CONSTRAINT procurement_items_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES public.warehouses(id);


--
-- Name: procurement_payments procurement_payments_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_payments
    ADD CONSTRAINT procurement_payments_document_id_fkey FOREIGN KEY (document_id) REFERENCES public.documents(id);


--
-- Name: procurement_payments procurement_payments_procurement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_payments
    ADD CONSTRAINT procurement_payments_procurement_id_fkey FOREIGN KEY (procurement_id) REFERENCES public.procurement_requests(id) ON DELETE CASCADE;


--
-- Name: procurement_payments procurement_payments_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_payments
    ADD CONSTRAINT procurement_payments_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.users(id);


--
-- Name: procurement_requests procurement_requests_approved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_requests
    ADD CONSTRAINT procurement_requests_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.users(id);


--
-- Name: procurement_requests procurement_requests_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_requests
    ADD CONSTRAINT procurement_requests_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.users(id);


--
-- Name: procurement_requests procurement_requests_dir_approved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_requests
    ADD CONSTRAINT procurement_requests_dir_approved_by_fkey FOREIGN KEY (dir_approved_by) REFERENCES public.users(id);


--
-- Name: procurement_requests procurement_requests_pm_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_requests
    ADD CONSTRAINT procurement_requests_pm_id_fkey FOREIGN KEY (pm_id) REFERENCES public.users(id);


--
-- Name: procurement_requests procurement_requests_proc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_requests
    ADD CONSTRAINT procurement_requests_proc_id_fkey FOREIGN KEY (proc_id) REFERENCES public.users(id);


--
-- Name: procurement_requests procurement_requests_tender_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_requests
    ADD CONSTRAINT procurement_requests_tender_id_fkey FOREIGN KEY (tender_id) REFERENCES public.tenders(id);
...
--
-- Name: staff_requests staff_requests_work_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staff_requests
    ADD CONSTRAINT staff_requests_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.tasks
    ADD CONSTRAINT tasks_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: procurement_requests tmc_requests_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_requests
    ADD CONSTRAINT tmc_requests_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);


--
-- Name: procurement_requests tmc_requests_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.procurement_requests
    ADD CONSTRAINT tmc_requests_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
--
-- Name: training_applications training_applications_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.training_applications
    ADD CONSTRAINT training_applications_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);
...
--
-- Name: training_applications training_applications_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.training_applications
    ADD CONSTRAINT training_applications_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
--
-- Name: travel_expenses travel_expenses_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.travel_expenses
    ADD CONSTRAINT travel_expenses_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);
...
--
-- Name: travel_expenses travel_expenses_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.travel_expenses
    ADD CONSTRAINT travel_expenses_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
ALTER TABLE ONLY public.travel_expenses
    ADD CONSTRAINT travel_expenses_work_id_fkey FOREIGN KEY (work_id) REFERENCES public.works(id) ON DELETE SET NULL;
...
--
-- Name: user_stories user_stories_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_stories
    ADD CONSTRAINT user_stories_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: work_expenses work_expenses_buh_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.work_expenses
    ADD CONSTRAINT work_expenses_buh_id_fkey FOREIGN KEY (buh_id) REFERENCES public.users(id);
...
--
-- Name: work_expenses work_expenses_payment_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.work_expenses
    ADD CONSTRAINT work_expenses_payment_doc_id_fkey FOREIGN KEY (payment_doc_id) REFERENCES public.documents(id);
...
--
-- Name: worker_profiles worker_profiles_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.worker_profiles
    ADD CONSTRAINT worker_profiles_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: worker_profiles worker_profiles_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.worker_profiles
    ADD CONSTRAINT worker_profiles_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(id);
...
\unrestrict tQuFFaaTL42XFfF5rJgWzTtdNBa1BPk1d1LeETXczHOdbMbUO6tCtz75PKRAvG3
