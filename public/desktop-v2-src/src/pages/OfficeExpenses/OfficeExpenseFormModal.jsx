...
export function OfficeExpenseFormModal({ expense, onDone }) {
  ...
  // Vanilla office_expenses.js → checkbox "Есть договор" + ввод номера договора.
  const [hasContract, setHasContract] = useState(!!expense?.contract_id || !!expense?.contract_number);
  const [contractNumber, setContractNumber] = useState(
    expense?.contract_number || (expense?.contract_id ? `#${expense.contract_id}` : '')
  );
