...
const SHELL_VERSION = '16.1.0-auth-fix';
...
const SHELL_ASSETS = [
  ...
  './assets/js/push-notifications.js?v=15.0.0',
  ...
  // ── Mobile v3: Core ──
  './assets/js/mobile_v3/approval.js',
  './assets/js/mobile_v3/auth.js',
  './assets/js/mobile_v3/components.js',
  ...
  './assets/js/mobile_v3/pages/all_estimates.js',
  './assets/js/mobile_v3/pages/all_works.js',
  './assets/js/mobile_v3/pages/approval_payment.js',
  './assets/js/mobile_v3/pages/approvals.js',
  './assets/js/mobile_v3/pages/backup.js',
  './assets/js/mobile_v3/pages/cash.js',
  './assets/js/mobile_v3/pages/cash_admin.js',
  './assets/js/mobile_v3/pages/contracts.js',
  './assets/js/mobile_v3/pages/correspondence.js',
  './assets/js/mobile_v3/pages/customers.js',
  './assets/js/mobile_v3/pages/dashboard.js',
  './assets/js/mobile_v3/pages/diag.js',
  './assets/js/mobile_v3/pages/finances.js',
  './assets/js/mobile_v3/pages/funnel.js',
  './assets/js/mobile_v3/pages/gantt.js',
  './assets/js/mobile_v3/pages/hr_requests.js',
  './assets/js/mobile_v3/pages/integrations.js',
  './assets/js/mobile_v3/pages/invoices.js',
  './assets/js/mobile_v3/pages/meetings.js',
  './assets/js/mobile_v3/pages/messenger.js',
  './assets/js/mobile_v3/pages/my_equipment.js',
  './assets/js/mobile_v3/pages/my_mail.js',
  './assets/js/mobile_v3/pages/office_expenses.js',
  './assets/js/mobile_v3/pages/pass_requests.js',
  './assets/js/mobile_v3/pages/payroll.js',
  './assets/js/mobile_v3/pages/permits.js',
  './assets/js/mobile_v3/pages/personnel.js',
  './assets/js/mobile_v3/pages/pm_calcs.js',
  './assets/js/mobile_v3/pages/pm_works.js',
  './assets/js/mobile_v3/pages/pre_tenders.js',
  './assets/js/mobile_v3/pages/proc_requests.js',
  './assets/js/mobile_v3/pages/profile.js',
  './assets/js/mobile_v3/pages/proxies.js',
  './assets/js/mobile_v3/pages/seals.js',
  './assets/js/mobile_v3/pages/settings.js',
  './assets/js/mobile_v3/pages/tasks.js',
  './assets/js/mobile_v3/pages/tasks_admin.js',
  './assets/js/mobile_v3/pages/telegram.js',
  './assets/js/mobile_v3/pages/tenders.js',
  './assets/js/mobile_v3/pages/tmc_requests.js',
  './assets/js/mobile_v3/pages/training.js',
  './assets/js/mobile_v3/pages/travel.js',
  './assets/js/mobile_v3/pages/warehouse.js',
  './assets/js/mobile_v3/pages/workers_schedule.js',
  // ── Mobile v3: Widgets (27 files) ──
  './assets/js/mobile_v3/widgets/approvals.js',
  './assets/js/mobile_v3/widgets/bank_summary.js',
  './assets/js/mobile_v3/widgets/birthdays.js',
  './assets/js/mobile_v3/widgets/calendar.js',
  './assets/js/mobile_v3/widgets/cash_balance.js',
  './assets/js/mobile_v3/widgets/equipment_alerts.js',
  './assets/js/mobile_v3/widgets/equipment_value.js',
  './assets/js/mobile_v3/widgets/gantt_mini.js',
  './assets/js/mobile_v3/widgets/kpi_summary.js',
  './assets/js/mobile_v3/widgets/money_summary.js',
  './assets/js/mobile_v3/widgets/my_cash_balance.js',
  './assets/js/mobile_v3/widgets/my_mail.js',
  './assets/js/mobile_v3/widgets/my_works.js',
  './assets/js/mobile_v3/widgets/notifications.js',
  './assets/js/mobile_v3/widgets/overdue_works.js',
  './assets/js/mobile_v3/widgets/payroll_pending.js',
  './assets/js/mobile_v3/widgets/permits_expiry.js',
  './assets/js/mobile_v3/widgets/platform_alerts.js',
  './assets/js/mobile_v3/widgets/pre_tenders.js',
  './assets/js/mobile_v3/widgets/quick_actions.js',
  './assets/js/mobile_v3/widgets/receipt_scanner.js',
  './assets/js/mobile_v3/widgets/team_workload.js',
  './assets/js/mobile_v3/widgets/telephony.js',
  './assets/js/mobile_v3/widgets/tender_dynamics.js',
  './assets/js/mobile_v3/widgets/tenders_funnel.js',
  './assets/js/mobile_v3/widgets/todo.js',
  './assets/js/mobile_v3/widgets/welcome.js'
];
