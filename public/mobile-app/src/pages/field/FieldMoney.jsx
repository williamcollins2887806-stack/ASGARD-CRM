...
/* ══════════════════════════════════════════════════════════════════
   PerDiemBalanceCard — УДАЛЕНА 23.06.2026 BUG-FIX (🟡 Payouts-5).
   Виджет ещё с 25.05.2026 НЕ вызывается в рендере (см. ~стр. 510 — явный
   комментарий-плейсхолдер «УДАЛЕНА 25.05.2026»). Логика «балансов суточных»
   переехала на страницу «Зарплата по месяцам». Тело функции
   (~200 строк JSX + конфиг 4 статусов) — мёртвый код, удалено целиком,
   чтобы перестать тянуть его в бандл и сбивать аудит «откуда берётся это».
   Если виджет нужно вернуть — поднять из git-истории до этого коммита.
   ══════════════════════════════════════════════════════════════════ */
/* ══════════════════════════════════════════════════════════════════
