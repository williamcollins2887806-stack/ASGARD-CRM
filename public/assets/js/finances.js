    ...
    function renderPage(){
      ...
      const body = `
        <style>
          ...
          .fin-tabs { display:flex; gap:4px; background:var(--bg-elevated); padding:4px; border-radius:6px; }
          ...
          .fin-card { background:var(--bg-elevated); border-radius:6px; padding:16px; }
          ...
          .fin-chart-container { background:var(--bg-elevated); border-radius:6px; padding:24px; margin-bottom:24px; }
