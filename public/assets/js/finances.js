    ...
    function renderPage(){
      ...
      const body = `
        <style>
          ...
          .fin-tabs { display:flex; gap:4px; background:var(--bg3); padding:4px; border-radius:6px; }
          ...
          .fin-card { background:var(--bg2); border:1px solid var(--line); border-radius:6px; padding:16px; }
          ...
          .fin-chart-container { background:var(--bg3); border:1px solid var(--line); border-radius:6px; padding:24px; margin-bottom:24px; }
