...
window.AsgardFinancesPage = (function(){
  ...
  async function render({layout, title}){
    ...
    function collectData(year){
      ...
      // === Расходы из РЕАЛЬНЫХ данных (work_expenses + office_expenses) ===
      for(const exp of workExpenses) {
    ...
    function renderPage(){
      ...
      const maxMonthDisplay = Math.max(...currentData.months);
      const maxMonth = Math.max(maxMonthDisplay, 1);
      const maxMonthIdx = currentData.months.indexOf(maxMonthDisplay);
      ...
      const body = `
        <style>
          ...
          .fin-tabs { display:flex; gap:4px; background:var(--bg-elevated, rgba(13,20,40,.6)); padding:4px; border-radius:6px; }
          ...
          .fin-card { background:var(--bg-card, rgba(13,20,40,.5)); border:1px solid var(--line); border-radius:6px; padding:16px; }
          ...
          .fin-chart-container { background:var(--bg-elevated, rgba(13,20,40,.4)); border:1px solid var(--line); border-radius:6px; padding:24px; margin-bottom:24px; }
          ...
          /* ═══ MOBILE_FINANCE_STYLES ═══ */
          @media(max-width:768px) {
            .fin-header { flex-direction:column; gap:10px; }
            .fin-tabs { width:100%; justify-content:center; flex-wrap:wrap; }
            .fin-tab { padding:8px 14px; font-size:12px; flex:1; text-align:center; }
            .fin-year-nav { justify-content:center; }
            .fin-year { font-size:22px; min-width:70px; }
            .fin-arrow { width:36px; height:36px; }
            .fin-summary { grid-template-columns:1fr 1fr !important; gap:8px !important; }
            .fin-card { padding:12px !important; }
            .fin-card-label { font-size:9px !important; letter-spacing:0.06em !important; }
            .fin-card-value { font-size:18px !important; }
            .fin-card-sub { font-size:11px !important; }
            .fin-chart-container { padding:14px !important; }
            .fin-chart-title { font-size:14px !important; }
            .fin-bars { height:160px !important; gap:4px !important; padding:0 4px !important; overflow-x:auto; -webkit-overflow-scrolling:touch; }
            .fin-bar-wrap { min-width:24px; }
            .fin-bar { max-width:32px !important; }
            .fin-bar-label { font-size:9px !important; }
            .fin-bar-value { font-size:9px !important; }
            .fin-pie-container { flex-direction:column !important; align-items:center !important; gap:16px !important; }
            .fin-pie { width:160px !important; height:160px !important; }
            .fin-pie-total { font-size:14px !important; }
            .fin-legend { min-width:0 !important; width:100% !important; }
            .fin-legend-item { padding:8px 0 !important; gap:8px !important; }
            .fin-legend-label { font-size:12px !important; }
            .fin-legend-value { font-size:12px !important; }
            .fin-legend-pct { font-size:10px !important; }
            .fin-month-title { font-size:16px !important; }
          }
        </style>
