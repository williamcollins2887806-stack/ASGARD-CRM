window.AsgardSeed = (function(){
  ...
  const DEFAULT_SETTINGS = {
    ...
    status_colors: {
      tender: {
        "Новый": "#2a6cf1",
        "Отправлено на просчёт": "var(--gold-l)",
        "Расчеты": "#2a6cf1",
        "Общение с заказчиком": "var(--purple)",
        "Расчет цены": "var(--cyan)",
        "Согласование ТКП": "var(--amber)",
        "Клиент согласился": "var(--ok-t)",
      ...
      work: {
        "Подготовка": "#2a6cf1",
        "Закупка": "var(--amber)",
        "Сбор на складе": "var(--cyan)",
        "Мобилизация": "var(--purple)",
        "Начало работ": "var(--ok-t)",
        "Приемка": "var(--gold-l)",
        "Проблема": "#e03a4a",
        "Подписание акта": "var(--ok)",
        "Работы сдали": "var(--ok-t)"
      },
  ...
  const DEFAULT_REFS = {
    tender_statuses: ["Черновик","Новый","Отправлено на просчёт","Расчеты","Общение с заказчиком","Расчет цены","Согласование ТКП","Клиент согласился","Клиент отказался","Другое"],
