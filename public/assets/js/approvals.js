  ...
  async function render({layout, title}){
    ...
    async function openEstimate(id){
      ...
      if(quickCalc && !v2Summary){
        ...
        quickCard = `
          <div style="background:var(--bg-elevated); border-radius:var(--radius-lg); padding:16px; margin-bottom:16px">
            ...
            <div style="margin-top:12px; display:flex; gap:8px; flex-wrap:wrap; font-size:12px">
              <span style="background:var(--bg-hover); padding:4px 8px; border-radius:6px">Маржа: ${margin.toFixed(1)}%</span>
              <span style="background:var(--bg-hover); padding:4px 8px; border-radius:6px">Прибыль: ${money(Math.round(profit))}</span>
              ${quickCalc.city ? `<span style="background:var(--bg-hover); padding:4px 8px; border-radius:6px">Город: ${esc(quickCalc.city)} (${quickCalc.distance_km||0} км)</span>` : ''}
      ...
      const v2Card = v2Summary ? `
        <div style="background:var(--bg-elevated); border-radius:var(--radius-lg); padding:16px; margin-bottom:16px">
          ...
          <div style="margin-top:12px; display:flex; gap:8px; flex-wrap:wrap; font-size:12px">
            <span style="background:var(--bg-hover); padding:4px 8px; border-radius:6px">Маржа: ${v2Summary.margin_pct}%</span>
            <span style="background:var(--bg-hover); padding:4px 8px; border-radius:6px">Чистая прибыль: ${money(v2Summary.net_profit)}</span>
