    ...
    const html = `
      <div class="warehouse-page">
        ...
        <div class="stats-row" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:12px;margin-bottom:20px">
          <div style="background:var(--bg-card);padding:16px;border-radius:6px;text-align:center">
          ...
          ${isDirector ? `
            <div style="background:linear-gradient(135deg,var(--bg-deep,#1e3a5f),var(--bg-card,#2a3b66));padding:16px;border-radius:6px;text-align:center;border:1px solid var(--accent)">
