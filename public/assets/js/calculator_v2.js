  ...
  async function open({ tender, estimate, user }) {
    ...
    function render() {
      ...
      const html = `<style>
        ...
        .calc-tabs .tab{padding:8px 12px;border-radius:6px;background:var(--bg3);border:none;cursor:pointer;font-size:12px}
        ...
        .csec{background:var(--bg3);border:none;border-radius:6px;padding:16px;margin-bottom:16px}
        ...
        .tbl th,.tbl td{padding:8px 10px;text-align:left;border-bottom:1px solid var(--brd)}
        ...
        .k{background:var(--bg3);border-radius:6px;padding:12px;text-align:center}
      ...
      <div style="margin-top:16px;padding:12px;background:var(--bg3);border-radius:6px;display:flex;justify-content:space-between">
    ...
    function render() {
      ...
      container.innerHTML = `
        <style>
          ...
          .k .v{font-size:18px;font-weight:700;color:var(--gold)}
          .mini{padding:4px 8px;font-size:11px}
          .calc-bottom-bar{margin-top:16px;padding:16px;background:var(--bg3);border-radius:6px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px}
