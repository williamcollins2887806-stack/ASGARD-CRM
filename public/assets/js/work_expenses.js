...
window.AsgardWorkExpenses = (function(){
  ...
  async function openExpensesModal(work, user){
    ...
    const html = `
      <style>
        .exp-summary { display:flex; gap:16px; flex-wrap:wrap; margin-bottom:16px; padding:12px; background:var(--bg-card); border-radius:12px; }
        ...
        .exp-mode-toggle { display:flex; gap:4px; background:var(--bg-card); padding:4px; border-radius:10px; margin-bottom:16px; }
        ...
        .exp-item { display:flex; align-items:center; gap:10px; padding:6px 0; border-bottom:1px solid var(--border); }
