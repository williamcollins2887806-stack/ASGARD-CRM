...
window.AsgardTasksPage = (function() {
  ...
  function renderTaskCard(t) {
    ...
    return `
      <div class="task-card" style="border-left:4px solid ${priorityColor}; background:var(--bg-card); padding:12px 15px; border-radius:8px; margin-bottom:10px; cursor:pointer; border:1px solid var(--border)"
