...
window.AsgardTelephonyPopup = (function () {
  ...
  function injectStyles() {
    ...
    el.textContent = [
      ...
      '}',
      '.tp-notch-pill { width: 86px; height: 4px; background: var(--brd-m); border-radius: 2px; }',
      '.tp-notch-cam  { width: 10px; height: 10px; background: var(--bg2);',
      '  border: 1.5px solid var(--brd-m); border-radius: 50%; }',
      ...
      '}',
      '.tp-status-label { font-size:11px; color:var(--t3); letter-spacing:0.2px; }',

      /* ── Divider ── */
      '.tp-divider { height:1px; background:var(--brd-m); margin:0 16px; }',
      ...
      '.tp-chat::-webkit-scrollbar-thumb { background: var(--brd-m); border-radius:2px; }',
      ...
      '.tp-btn-transfer { background:var(--bg3); color:var(--t1); }',
      '.tp-btn-transfer:hover { background:var(--bg4); }',
      '.tp-btn-answer   { background:var(--bg3); color:var(--t1); }',
      '.tp-btn-answer:hover   { background:var(--bg4); }',
      '.tp-btn-close    { flex:0 0 auto; width:38px; padding:9px;',
      '  background:var(--bg2); color:var(--t3); }',
      '.tp-btn-close:hover    { background:var(--bg3); color:var(--t1); }',
      ...
      '.tp-td::-webkit-scrollbar-thumb { background:var(--brd-m); border-radius:2px; }',
      '@keyframes tp-dd-in { from{transform:translateY(8px);opacity:0} to{transform:translateY(0);opacity:1} }',
      '.tp-td-item {',
      '  padding:9px 12px; font-size:12px; color:var(--t2);',
      '  cursor:pointer; border-bottom:1px solid var(--brd-m);',
      '  transition:background 0.15s; display:flex; align-items:center; gap:7px;',
      '}',
      '.tp-td-item:last-child { border-bottom:none; }',
      '.tp-td-item:hover { background:var(--bg3); }',
      '.tp-td-nm { font-weight:500; }',
      '.tp-td-ph { font-size:11px; color:var(--t3); }',
      ...
      '  border:1px solid var(--brd-m); border-radius:6px;',
