...
const ROLE_TABLES = {
  ...
  TO: {
    ...
    write: ['tenders', 'estimates', 'customers', 'correspondence', 'staff_plan'],
    noRead: ['audit_log'],
    noWrite: ['users', 'audit_log', 'equipment_maintenance', 'payroll_sheets']
  },
  HR: {
  ...
  PROC: {
    read: ['users', 'employees', 'staff', 'staff_plan', 'tenders', 'works', 'purchase_requests', 'equipment', 'invoices', 'documents'],
    write: ['purchase_requests', 'equipment_categories', 'invoices', 'documents', 'tenders', 'works', 'staff_plan'],
    noRead: ['audit_log'],
    noWrite: ['users', 'audit_log']
  },
  DIRECTOR_GEN: {
