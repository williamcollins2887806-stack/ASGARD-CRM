...
module.exports = {
  ...
  tests: [
    ...
    { name: 'WAREHOUSE cannot read employees', run: async () => { const r = await api('GET', '/api/data/employees?limit=1', { role: 'WAREHOUSE' }); assertStatus(r, 403, 'WH employees'); } },
    ...
    { name: 'WAREHOUSE cannot read staff', run: async () => { const r = await api('GET', '/api/data/staff?limit=1', { role: 'WAREHOUSE' }); assertStatus(r, 403, 'WH staff'); } },
    ...
    { name: 'PROC cannot read employees', run: async () => { const r = await api('GET', '/api/data/employees?limit=1', { role: 'PROC' }); assertStatus(r, 403, 'PROC employees'); } },
    { name: 'PROC cannot read tenders', run: async () => { const r = await api('GET', '/api/data/tenders?limit=1', { role: 'PROC' }); assertStatus(r, 403, 'PROC tenders'); } },
    { name: 'PROC cannot read works', run: async () => { const r = await api('GET', '/api/data/works?limit=1', { role: 'PROC' }); assertStatus(r, 403, 'PROC works'); } },
    ...
    { name: 'PROC cannot read staff', run: async () => { const r = await api('GET', '/api/data/staff?limit=1', { role: 'PROC' }); assertStatus(r, 403, 'PROC staff'); } },
    ...
    { name: 'TO cannot read staff', run: async () => { const r = await api('GET', '/api/data/staff?limit=1', { role: 'TO' }); assertStatus(r, 403, 'TO staff'); } },
    ...
    // HEAD_TO, HR_MANAGER, CHIEF_ENGINEER get 403 on everything (5 tests)
    { name: 'HEAD_TO cannot read tenders', run: async () => { const r = await api('GET', '/api/data/tenders?limit=1', { role: 'HEAD_TO' }); assertStatus(r, 403, 'HEAD_TO tenders'); } },
    { name: 'HEAD_TO cannot read employees', run: async () => { const r = await api('GET', '/api/data/employees?limit=1', { role: 'HEAD_TO' }); assertStatus(r, 403, 'HEAD_TO employees'); } },
    { name: 'HR_MANAGER cannot read tenders', run: async () => { const r = await api('GET', '/api/data/tenders?limit=1', { role: 'HR_MANAGER' }); assertStatus(r, 403, 'HR_MANAGER tenders'); } },
    { name: 'HR_MANAGER cannot read employees', run: async () => { const r = await api('GET', '/api/data/employees?limit=1', { role: 'HR_MANAGER' }); assertStatus(r, 403, 'HR_MANAGER employees'); } },
    { name: 'CHIEF_ENGINEER cannot read works', run: async () => { const r = await api('GET', '/api/data/works?limit=1', { role: 'CHIEF_ENGINEER' }); assertStatus(r, 403, 'CHIEF_ENGINEER works'); } },
