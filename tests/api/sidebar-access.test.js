...
const PERMISSION_ENDPOINTS = [
  ...
  },
  {
    ...
    allowed: ['TO', 'PM', 'HR', 'CHIEF_ENGINEER'],
...
const DATA_ACCESS = {
  ...
  HEAD_TO:         ['correspondence', 'documents', 'doc_sets',
                    'tenders', 'estimates', 'works', 'invoices',
                    'employees', 'customers', 'calendar_events',
                    'chats', 'chat_messages', 'notifications',
                    'sync_meta', 'reminders', 'user_dashboard',
                    'permits', 'tasks', 'pre_tender_requests',
                    'users', 'user_call_status'],
  HR_MANAGER:      ['tenders', 'works', 'invoices', 'employees',
                    'employee_reviews', 'employee_assignments', 'employee_plan',
                    ...
                    'travel_expenses', 'user_dashboard', 'users', 'user_call_status',
                    'employee_rates', 'payroll_sheets', 'payroll_items', 'permits'],
  CHIEF_ENGINEER:  ['equipment', 'equipment_categories', 'equipment_movements',
                    ...
                    'employees', 'calendar_events', 'users'],
  WAREHOUSE:       [],
};
