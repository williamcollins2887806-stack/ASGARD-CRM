...
const WRITE_ENDPOINTS = [
  ...
  { method: 'POST',   url: '/api/tenders',       allowed: ['ADMIN','PM','HEAD_PM','TO','HEAD_TO','DIRECTOR_GEN','DIRECTOR_COMM','DIRECTOR_DEV'],
    body: { customer_name: 'WAM-Test', tender_type: 'Прямой запрос' } },
  { method: 'PUT',    url: '/api/tenders/:id',    allowed: ['ADMIN','PM','HEAD_PM','TO','HEAD_TO','DIRECTOR_GEN','DIRECTOR_COMM','DIRECTOR_DEV'],
  ...
  // HEAD_PM inherits PM
  { method: 'POST',   url: '/api/works',          allowed: ['ADMIN','PM','HEAD_PM','DIRECTOR_GEN','DIRECTOR_COMM','DIRECTOR_DEV'],
    body: { work_title: 'WAM-Work' } },
  { method: 'PUT',    url: '/api/works/:id',       allowed: ['ADMIN','PM','HEAD_PM','DIRECTOR_GEN','DIRECTOR_COMM','DIRECTOR_DEV'],
