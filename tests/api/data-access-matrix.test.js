...
const ACCESS_MATRIX = {
  ...
  TO: {
    tables: ['users','employees','works','invoices','user_call_status','tenders','estimates','customers',
      'calendar_events','documents','correspondence','chats','chat_messages','notifications','sync_meta',
      'reminders','doc_sets','user_dashboard','permits']
  },
  BUH: {
    tables: ['users','employees','cash_requests','cash_expenses','cash_returns','cash_messages','user_call_status',
  ...
  OFFICE_MANAGER: {
    tables: ['users','employees','staff','staff_plan','office_expenses','calendar_events','correspondence',
      ...
      'sync_meta','reminders','contracts','travel_expenses','doc_sets','user_dashboard']
  },
  WAREHOUSE: {
    tables: ['users','equipment','equipment_categories','equipment_movements','equipment_requests',
  ...
  PROC: {
    tables: ['users','purchase_requests','equipment','equipment_categories','invoices','invoice_payments',
      'documents','calendar_events','chats','chat_messages','notifications','sync_meta','reminders',
      'user_dashboard']
  },
  HEAD_PM: {
    tables: ['users','employees','works','tenders','estimates','work_expenses','work_assign_requests',
      ...
      'payroll_items','one_time_payments']
  }
  // HEAD_TO, HR_MANAGER, CHIEF_ENGINEER are NOT in the matrix → they get 403 on everything
};
